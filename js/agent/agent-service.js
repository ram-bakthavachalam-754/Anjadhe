        ...
        try {
            ...
            while (iterations < this.maxToolIterations) {
                ...
                if (
                    ...
                    messages.push({
                        role: 'user',
                        content: 'You said you would do that — go ahead and call the appropriate tool now in this same turn. If no tool fits, answer from what you already know without announcing the action.' + taskRoute
                    });
                    continue;
                }
