...
const CalendarApp = {
    ...
    getScheduleEventsForDate(date) {
        ...
        for (const item of items) {
            ...
            // Hide completed tasks. For recurring tasks, completion is
            // per-day (lastCompletedDate === dateStr); for one-time tasks,
            // any lastCompletedDate means the task is done, so drop it from
            // every date including its originally scheduled one.
            if (isRepeating) {
