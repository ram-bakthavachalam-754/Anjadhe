    ...
    TOPICS: [
        ...
        // ── The assistant ────────────────────────────────────────────
        {
            ...
            body: `
                ...
                <p>The model runs on your Mac through Ollama, or on a server you own. There is no cloud AI option — your conversations and personal data only reach hardware you control. Pick and manage the model in Settings &rsaquo; AI (the gear icon in the assistant's header).</p>
        ...
        {
            id: 'prompts', group: 'The assistant', title: 'Scheduled prompts & the feed',
            blurb: 'Prompts that run on a schedule and post results to a feed.',
            body: `
                <p>A <strong>prompt note</strong> (Notes &rsaquo; + New Prompt) is a reusable instruction — "summarize AI news", "draft my weekly review questions". You can run it manually, or schedule it to run offline (daily, weekly…) on your local model.</p>
                <p>Scheduled runs post to the <strong>feed</strong> on your home page — each result shows when it ran and which model wrote it. Open a post to read it full-page; from there, <strong>Discuss with Assistant</strong> starts a chat that already has the result in context, so you can ask follow-ups immediately.</p>
        ...
        // ── Everyday apps ────────────────────────────────────────────
        {
            ...
            body: `
                ...
                <ul class="help-app-list">
                    <li><strong>Templates</strong> — a note can be <em>Blank</em>, a <em>Book</em> (chapters with a table of contents), or a <em>Prompt</em> (see Scheduled prompts).</li>
        ...
        // ── The platform ─────────────────────────────────────────────
        {
            ...
            body: `
                ...
                <p>AI runs on open-weight models — on this Mac through Ollama, or on a server you own. Your data and AI conversations only ever reach hardware you control.</p>
