 ...
 * lives in a nested `note.prompt = { target, offline, interval, web }` object
 ...
 * needs (the Notes editor, the offline PromptFeed scheduler, and the Browse
...
const NotePrompts = {
    DEFAULTS: { target: 'agent', offline: false, interval: 'daily', web: false, useContext: false },
